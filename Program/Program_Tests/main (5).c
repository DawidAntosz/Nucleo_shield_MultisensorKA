...
//==================================================================================
// function prototype - display making
...
int main(void)
{
  ...
  HAL_ADC_Start_DMA(&hadc1, (uint32_t *) bufferADC, 2);
...
void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef* hadc){
	number_display = bufferADC[0];

	tx_buf_length = sprintf(tx_buf,"%d, %d \n", bufferADC[0], bufferADC[1]);
...
// ==================================================================================
// obsługa wyswietlacza/ przyciskow
void Set_Sign(uint8_t count, uint8_t display_number){
